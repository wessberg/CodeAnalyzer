...
import {createPrinter, NewLineKind, Node, Printer as TypescriptPrinter, SourceFile, SyntaxKind} from "typescript";
...
export class Printer implements IPrinter {
	 ...
	 * @returns {string}
	 */
	public stringify (node: Node): string {
