...
export const Config: IConfig = {
	...
	builtInIdentifiers: new Set(["ReferenceError", "TypeError", "Error", "RangeError", "SyntaxError", "Date", "Promise", "Map", "WeakMap", "Set", "WeakSet", "Buffer", "URL", "String", "Object", "Array", "Function", "Symbol", "Number", "Boolean"])
};