...
import {ClassIndexer, EnumIndexer, FunctionIndexer, ICallExpression, IClassDeclaration, ICodeAnalyzer, IdentifierMapKind, IExportDeclaration, IIdentifierMap, IImportDeclaration, INewExpression, VariableIndexer} from "./interface/ICodeAnalyzer";
import {ICodeAnalyzerConfig} from "./interface/ICodeAnalyzerConfig";
...
export class CodeAnalyzer implements ICodeAnalyzer {
	...
	constructor (marshaller: IMarshaller,
							 ...
							 private config: ICodeAnalyzerConfig = {},
		...
		this.importFormatter = new ImportFormatter(this, this.sourceFilePropertiesGetter, this.nameGetter, this.callExpressionFormatter, this.variableFormatter, this.mapper, this.tracer, this.stringUtil, fileLoader);
		this.exportFormatter = new ExportFormatter(this, this.mapper, this.valueExpressionGetter, this.valueResolvedGetter, this.sourceFilePropertiesGetter, this.variableFormatter, this.classFormatter, this.functionFormatter, this.nameGetter, this.tracer, this.stringUtil, fileLoader);
	}
