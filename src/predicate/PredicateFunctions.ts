...
/**
 * A predicate function that returns true if the given Statement is a TypeQueryNode.
 * @param {Statement|Declaration|Expression|Node} statement
 * @returns {boolean}
 */
export function isTypeQueryNode (statement: Statement|Declaration|Expression|Node): statement is TypeQueryNode {
	return statement.kind === SyntaxKind.TypeQuery;
}
...
/**
 * A predicate function that returns true if the given Statement is an ImportExpression.
 * @param {Statement|Declaration|Expression|Node} statement
 * @returns {boolean}
 */
export function isImportExpression (statement: Statement|Declaration|Expression|Node): statement is ImportExpression {
	return statement.kind === SyntaxKind.ImportKeyword;
}

/**
 * A predicate function that returns true if the given Statement is a NonNullExpression.
 * @param {Statement|Declaration|Expression|Node} statement
 * @returns {boolean}
 */
export function isNonNullExpression (statement: Statement|Declaration|Expression|Node): statement is NonNullExpression {
	return statement.kind === SyntaxKind.NonNullExpression;
}
...
/**
 * A predicate function that returns true if the given Statement is a INamespacedModuleMap.
 * @param {IIdentifier|ArbitraryValue} statement
 * @returns {boolean}
 */
export function isNamespacedModuleMap (statement: IIdentifier|ArbitraryValue): statement is INamespacedModuleMap {
 ...
 * @returns {boolean}
 */
export function isNamespacedModuleIndexer (statement: IIdentifier|ArbitraryValue): statement is INamespacedModuleMap {
	return statement != null && (<IIdentifier>statement).___kind === IdentifierMapKind.NAMESPACED_MODULE_INDEXER;
}
